...
# added from cvml_project imports
# if packages aren't installed can use pip install to add open3d and utils
import os
import open3d
from utils import *
...
# TODO PICKUP HERE
    ...
    ### minimize
        ...
        xyz_array = list(point_cloud2.read_points(pc2_msg, field_names=('x','y','z',)))
        self.xyz = [tuple(row) for row in xyz_array]
